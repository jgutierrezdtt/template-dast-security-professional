# Paso 2. Primer escaneo dast

## Que vas a hacer en este paso?

Implementaras este control de DAST de forma concreta sobre el archivo `.zap/rules.tsv` y registraras evidencia tecnica en `.tutorial/evidence/step-02.json`.
