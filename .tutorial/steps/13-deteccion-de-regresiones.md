...
- El validador `scripts/validate-step-13.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-13.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 13 queda completado cuando el workflow reporta exito para `validate-step-13.py` en GitHub Actions.

Siguiente paso automatico: Paso 14.
