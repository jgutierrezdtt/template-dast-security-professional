...
- Campo o seccion objetivo: relacionado con "Gate bloqueante por severidad".
- Ubicacion principal: `.github/workflows/dast.yml`.
- Resultado esperado: que la configuracion refleje el control del paso 16.

## Checklist de configuracion

- El cambio del paso 16 esta presente en `.github/workflows/dast.yml`.
...
- `scripts/validate-step-16.py` valida que el control de este paso esta aplicado.
- El estado de progreso se refleja en `.tutorial/state.json`.

## Criterio de finalizacion

El paso 16 se marca como completado cuando GitHub Actions reporta exito para `validate-step-16.py`.
