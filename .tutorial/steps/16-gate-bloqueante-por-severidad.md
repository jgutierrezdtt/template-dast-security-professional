...
- El validador `scripts/validate-step-16.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-16.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 16 queda completado cuando el workflow reporta exito para `validate-step-16.py` en GitHub Actions.

Siguiente paso automatico: Paso 17.
