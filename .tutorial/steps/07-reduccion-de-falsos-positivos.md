...
Implementaras este control de DAST de forma concreta sobre el archivo `.github/workflows/dast.yml` y registraras evidencia tecnica en `.tutorial/evidence/step-07.json`.
...
{
  "step": 7,
  "title": "Reduccion de falsos positivos",
  "status": "completed",
