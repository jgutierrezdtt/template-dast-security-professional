...
- El validador `scripts/validate-step-19.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-19.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 19 queda completado cuando el workflow reporta exito para `validate-step-19.py` en GitHub Actions.

Siguiente paso automatico: Paso 20.
