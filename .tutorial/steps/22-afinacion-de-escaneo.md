...
- Campo o seccion objetivo: relacionado con "Afinacion de escaneo".
- Ubicacion principal: `.github/workflows/dast.yml`.
- Resultado esperado: que la configuracion refleje el control del paso 22.

## Checklist de configuracion

- El cambio del paso 22 esta presente en `.github/workflows/dast.yml`.
...
- `scripts/validate-step-22.py` valida que el control de este paso esta aplicado.
- El estado de progreso se refleja en `.tutorial/state.json`.

## Criterio de finalizacion

El paso 22 se marca como completado cuando GitHub Actions reporta exito para `validate-step-22.py`.
