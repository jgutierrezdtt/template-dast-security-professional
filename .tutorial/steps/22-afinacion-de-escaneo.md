...
- El validador `scripts/validate-step-22.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-22.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 22 queda completado cuando el workflow reporta exito para `validate-step-22.py` en GitHub Actions.

Siguiente paso automatico: Paso 23.
