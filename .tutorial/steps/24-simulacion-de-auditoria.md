...
- El validador `scripts/validate-step-24.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-24.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 24 queda completado cuando el workflow reporta exito para `validate-step-24.py` en GitHub Actions.

Siguiente paso automatico: Paso 25.
