...
- Campo o seccion objetivo: relacionado con "Medalla final dast professional".
- Ubicacion principal: `.github/workflows/dast.yml`.
- Resultado esperado: que la configuracion refleje el control del paso 25.

## Checklist de configuracion

- El cambio del paso 25 esta presente en `.github/workflows/dast.yml`.
...
- `scripts/validate-step-25.py` valida que el control de este paso esta aplicado.
- El estado de progreso se refleja en `.tutorial/state.json`.

## Criterio de finalizacion

El paso 25 se marca como completado cuando GitHub Actions reporta exito para `validate-step-25.py`.
