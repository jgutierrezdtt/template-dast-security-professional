...
- El validador `scripts/validate-step-25.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-25.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 25 queda completado cuando el workflow reporta exito para `validate-step-25.py` en GitHub Actions.
