...
Implementaras este control de DAST de forma concreta sobre el archivo `.zap/rules.tsv` y registraras evidencia tecnica en `.tutorial/evidence/step-04.json`.
